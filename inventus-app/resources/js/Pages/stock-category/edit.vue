...
const submit = () => {
    form.patch(`/stock-categories/${props.category.id}`, {
        preserveState: true,
        onFinish: () => {
...
<template>
    <Head title="Editar Categoria - Inventus +" />
    <div class="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
        ...
        <main class="flex-1 max-w-2xl w-full mx-auto px-6 py-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-xl font-bold text-white tracking-tight">Editar Categoria</h1>
                    <p class="text-xs text-zinc-400 mt-0.5">Atualize os dados de {{ form.name || 'categoria' }}</p>
                </div>
                <Link
                ...
                <form @submit.prevent="submit()" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-zinc-800">
                        ...
                        >
                            ...
                            <span v-else>Atualizar Categoria</span>
                        </button>
                    </div>
                </form>
            </div>
