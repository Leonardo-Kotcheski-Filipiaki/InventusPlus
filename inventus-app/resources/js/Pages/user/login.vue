...
<template>
    ...
    <div class="h-screen w-screen flex flex-col bg-neutral-700">
        <div class="h-screen w-screen flex flex-col items-center justify-center">
            <div class="w-full flex items-center justify-center">
                <h1 class="text-6xl font-black text-center text-white">Inventus +</h1>
            </div>
            <div class="w-full flex flex-col items-center justify-center p-6 gap-5">
                ...
                <form @submit.prevent="login()" class="flex flex-col gap-5">
                    <div class="relative flex flex-col">
                        ...
                        <span v-if="form.errors.login" class="absolute -bottom-6 left-10 text-red-400 text-md font-semibold">
                            {{ form.errors.login }}
                        </span>
                    </div>
                    ...
                    <div class="relative flex flex-col">
                        ...
                        <span v-if="form.errors.password" class="absolute -bottom-6 left-10 text-red-400 text-md font-semibold">
