...
// Ao selecionar o produto, preenche o valor unitário automaticamente com o preço cadastrado
...
<template>
    <Head title="Registrar Venda / Movimentação - Inventus +" />
    <div class="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
        ...
        <main class="flex-1 max-w-3xl w-full mx-auto px-6 py-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-xl font-bold text-white tracking-tight">Registrar Movimentação / Venda</h1>
                    <p class="text-xs text-zinc-400 mt-0.5">Selecione o tipo de operação, produto e parceiro comercial</p>
                </div>
                <Link
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div v-if="selectedProduct" class="mt-2 text-xs flex items-center gap-2">
                                ...
                                <span v-if="form.sales_type === 'saida' && Number(form.quantity) > Number(selectedProduct.quantity)" class="text-rose-400 font-medium">
                                    ⚠️ A quantidade ultrapassa o estoque disponível!
                                </span>
                            </div>
                        </div>
