...
form.name = props.costumer.person.name;
form.cpf = props.costumer.person.cpf;
form.cnpj = props.costumer.person.cnpj;
console.log(props.costumer.person.birthdate);
form.birthdate = props.costumer.person.birthdate;
form.email = props.costumer.person.email;
form.phone = props.costumer.person.phone;
...
<template>
    ...
    <div class="flex justify-center max-w-full mt-10 ">
        <form class="border border-gray-500 rounded-md p-10" @submit.prevent="submit()" method="post">
            <h1 class="text-center font-semibold text-2xl">Alterar Cliente</h1>
